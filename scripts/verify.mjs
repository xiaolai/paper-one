 ...
 * literal desktop build (which asserts its own bundle), the CLI's bundle
 * (which asserts its own output), then Cargo — the lockfile, formatting,
 * clippy, tests — for the whole workspace.
 *
